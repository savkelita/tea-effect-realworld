...
export const view =
  ...
  (_dispatch: Platform.Dispatch<Msg>) =>
    (
      <Card>
        <CardHeader header={<Title1>About</Title1>} />
        <Text>
          <strong>tea-effect</strong> is a TypeScript implementation of The Elm Architecture using the Effect ecosystem.
        </Text>
        <Text>
          It brings type-safe side effects, declarative state management, and unidirectional data flow to React.
        </Text>
      </Card>
    )
